...
userProfileSchema.statics.fetchProfile = async function(userId, guildId, username, guildMember = null) {
  ...
  if (!userProfile) {
    ...
    // Проверка целостности структур (на случай миграций)
